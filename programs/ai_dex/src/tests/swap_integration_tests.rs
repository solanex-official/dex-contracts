...
const CATCHABLE_ERRORS: [(&str, ErrorCode); 8] = [
    (
        "MultiplicationShiftRightOverflowError",
        ErrorCode::MultiplicationShiftRightOverflowError,
    ),
    ("TokenLimitExceededError", ErrorCode::TokenLimitExceededError),
    ("DivisionByZeroError", ErrorCode::DivisionByZeroError),
    ("SqrtPriceOutOfBoundsError", ErrorCode::SqrtPriceOutOfBoundsError),
    (
        "InvalidTickArraySequenceError",
        ErrorCode::InvalidTickArraySequenceError,
    ),
    ("NoTradableAmountError", ErrorCode::NoTradableAmountError),
    ("NumberDowncastError", ErrorCode::NumberDowncastError),
    ("MultiplicationOverflowError", ErrorCode::MultiplicationOverflowError),
];

#[test]
/// Run a collection of tests on the swap_orchestrator against expectations
