...
fn get_amount_fixed_delta(
    ...
    match a_to_b == amount_specified_is_input {
        true => get_amount_delta_a(
            sqrt_price_current,
            sqrt_price_target,
            liquidity,
            amount_specified_is_input,
        ),
        false => get_amount_delta_b(
            sqrt_price_current,
            sqrt_price_target,
            liquidity,
            amount_specified_is_input,
...
fn get_amount_unfixed_delta(
    ...
    match a_to_b == amount_specified_is_input {
        true => get_amount_delta_b(
            sqrt_price_current,
            sqrt_price_target,
            liquidity,
            !amount_specified_is_input,
        ),
        false => get_amount_delta_a(
            sqrt_price_current,
            sqrt_price_target,
            liquidity,
            !amount_specified_is_input,
...
mod unit_tests {
    ...
    mod test_swap {
        ...
        fn validate_tick_ai_dex() {
            // Validate tick values
            // Fee, reward growths
            //
            // Validate ai_dex values
